...
_CONFIGS = [
    ...
    # ==================== AgiBot G01 π0.5 adaptation: independent 16-step train config BEGIN ====================
    TrainConfig(
        name="pi05_agibot_g01_h16",
    ...
    # ==================== AgiBot G01 π0.5 adaptation: independent 16-step train config END ====================
